...
const PlinkoGame = ({ onScore, lastDrop, pegSoundMode })=>{
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$PLINKO$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useEffect"])(()=>{
        const initAudio = async ()=>{
            try {
                ...
                await Promise.all([
                    loadAudio('/ui/sounds/peghit.mp3', 'peg-default'),
    ...
    const playSound = (soundKey, volume = 0.3, duration, pitch = 1.0)=>{
        ...
        try {
            ...
            try {
                let audioPath = '';
                if (soundKey === 'peg-default') audioPath = '/ui/sounds/peghit.mp3';
                else if (soundKey === 'peg-alt') audioPath = '/ui/sounds/peghitalt.wav';
                else if (soundKey === 'bucket') audioPath = '/ui/sounds/bucketHit.wav';
                else if (soundKey === 'negative') audioPath = '/ui/sounds/negative.mp3';
                if (audioPath) {
    ...
    const playPegHitSound = (pegY)=>{
        ...
        if (timeSinceLastSound >= 30 && activePegSounds.current < MAX_CONCURRENT_PEG_SOUNDS) {
            ...
            // Use selected sound mode
            const soundKey = pegSoundMode === 'default' ? 'peg-default' : 'peg-alt';
            playSound(soundKey, 0.12, 0.08, pitch); // Reduced volume, cut to 80ms, variable pitch
        }
    };
...
"[project]/PLINKO/components/SoundToggle.tsx [app-ssr] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$PLINKO$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/PLINKO/node_modules/next/dist/server/route-modules/app-page/vendored/ssr/react-jsx-dev-runtime.js [app-ssr] (ecmascript)");
;
const SoundToggle = ({ soundMode, onSoundModeChange })=>{
    const modes = [
        {
            key: 'off',
            label: 'OFF',
    ...
    const currentIndex = modes.findIndex((mode)=>mode.key === soundMode);
    const nextMode = ()=>{
        const nextIndex = (currentIndex + 1) % modes.length;
        onSoundModeChange(modes[nextIndex].key);
    };
    const prevMode = ()=>{
        const prevIndex = (currentIndex - 1 + modes.length) % modes.length;
        onSoundModeChange(modes[prevIndex].key);
    };
    return /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$PLINKO$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
        className: "bg-black/5 rounded-2xl p-3 border border-black/10 shadow-inner",
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$PLINKO$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$PLINKO$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            ...
                            fileName: "[project]/PLINKO/components/SoundToggle.tsx",
                            lineNumber: 32,
                            columnNumber: 11
                        }, ("TURBOPACK compile-time value", void 0)),
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$PLINKO$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                            className: "text-black font-mono font-bold text-xs",
                            children: modes[currentIndex].label
                        }, void 0, false, {
                            fileName: "[project]/PLINKO/components/SoundToggle.tsx",
                            lineNumber: 33,
                            columnNumber: 11
                ...
                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$PLINKO$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                    ...
                    children: [
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$PLINKO$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("button", {
                            onClick: prevMode,
                            className: "w-6 h-6 rounded-full bg-black/10 hover:bg-black/20 flex items-center justify-center text-black border border-black/20 hover:border-black/30 transition-all duration-200 text-xs",
                            children: "‹"
                        }, void 0, false, {
                            fileName: "[project]/PLINKO/components/SoundToggle.tsx",
                            lineNumber: 40,
                        ...
                        /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$PLINKO$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            className: "flex items-center gap-1 px-2 py-1 bg-black/10 rounded-lg border border-black/20",
                            children: [
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$PLINKO$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: "text-sm",
                                    children: modes[currentIndex].icon
                                }, void 0, false, {
                                    fileName: "[project]/PLINKO/components/SoundToggle.tsx",
                                    lineNumber: 49,
                                    columnNumber: 13
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$PLINKO$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("span", {
                                    className: "text-black font-bold text-[10px] uppercase tracking-wider",
                                    children: modes[currentIndex].label
                                }, void 0, false, {
                                    fileName: "[project]/PLINKO/components/SoundToggle.tsx",
                                    lineNumber: 50,
...
const __TURBOPACK__default__export__ = SoundToggle;
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$PLINKO$2f$components$2f$SoundToggle$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/PLINKO/components/SoundToggle.tsx [app-ssr] (ecmascript)");
'use client';
;
;
;
...
const Home = ()=>{
    ...
    const [pegSoundMode, setPegSoundMode] = (0, __TURBOPACK__imported__module__$5b$project$5d2f$PLINKO$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["useState"])('default');
                    ...
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$PLINKO$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$PLINKO$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                            ...
                            children: [
                                ...
                                /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$PLINKO$2f$node_modules$2f$next$2f$dist$2f$server$2f$route$2d$modules$2f$app$2d$page$2f$vendored$2f$ssr$2f$react$2d$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["jsxDEV"])(__TURBOPACK__imported__module__$5b$project$5d2f$PLINKO$2f$components$2f$SoundToggle$2e$tsx__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"], {
                                    soundMode: pegSoundMode,
                                    onSoundModeChange: setPegSoundMode
                                }, void 0, false, {
                                    fileName: "[project]/PLINKO/app/page.tsx",
                                    lineNumber: 216,
                                    columnNumber: 13
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d4fff0d1._.js.map